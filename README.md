...
```
pip install dist/nomad-tutorial13following-0.1.0
```
...
### License
Distributed under the terms of the `MIT`_ license, "nomad-tutorial13following" is free and open source software
